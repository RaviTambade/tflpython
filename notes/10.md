...
Imagine I take you into a large bank. There are:
- 20 branches
- 500 employees
- 100,000 customers
- thousands of transactions every day

Ravi Sir: “How many vaults should contain the bank's central reserve?” Student says:> Student: “Sir, one?” Exactly! Why? Because if every branch creates its own independent central vault, we have a serious problem.
...
There is no single source of truth. Instead, the bank wants:
...
Not exactly. Python separates object creation and object initialization. Conceptually:
...
because the second construction initializes the same object again. That teaches us an important lesson:
...
🤔 But Ravi Sir, Should Everything Be Singleton? No! This is one of the most important lessons. Suppose we have:
...
Students: “Sir, if Singleton is so useful, why don't we make every class Singleton?” Because global shared state can create problems.
